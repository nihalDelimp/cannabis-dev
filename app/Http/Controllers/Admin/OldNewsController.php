...
class NewsController extends Controller{
  ...
  public function update(Request $request){
    ...
    if(!empty($image)){
      ...
      resize_image($destinationPath.'/'.$update['image'],$destinationPath.'/listing'.'/'.$update['image'],360,180);
      resize_image($destinationPath.'/'.$update['image'],$destinationPath.'/main'.'/'.$update['image'],760,450);
