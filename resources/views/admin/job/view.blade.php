...
@section('content')
  ...
  <section class="content">
    ...
    @endif
    <form method="post" action="#" id="view_job_detail">
    @csrf
    @method('PATCH')
    ...
    <input class="form-control" name="customer_name" value="{{ $job->customer_name }}"  type="text" id="customer_name" placeholder="{{langMessage('customer name')}}" required disabled>
    @error('customer_name')
        <span class="text-danger" role="alert">
            <strong>{{langMessage(strtolower($message))}}</strong>
        </span>
    ...
    <input class="form-control" name="service_address" value="{{ $job->service_address }}" type="text" id="service_address" placeholder="{{langMessage('service address')}}" required disabled>
    ...
    <input class="form-control" name="city" value="{{ $job->city }}" type="text" id="city" placeholder="{{langMessage('city')}}" required disabled>
    @error('city')
        <span class="text-danger" role="alert">
            <strong>{{langMessage(strtolower($message))}}</strong>
        </span>
    ...
    <input class="form-control" name="zip_code" value="{{ $job->zip_code }}" type="text" id="zip_code" placeholder="{{langMessage('zip code')}}" required disabled>
    @error('zip_code')
        <span class="text-danger" role="alert">
            <strong>{{langMessage(strtolower($message))}}</strong>
        </span>
    ...
    <input class="form-control" name="phone_number" value="{{ $job->phone_number }}" type="text" id="zip_code" placeholder="{{langMessage('phone number')}}" required disabled>
    </div>
    @error('phone_number')
        <span class="text-danger" role="alert">
            <strong>{{langMessage(strtolower($message))}}</strong>
    ...
    <div class="input-group">
    <span class="input-group-addon">+1</span>
    <input class="form-control" name="cell_number" value="{{ $job->cell_number }}" type="text" id="zip_code" placeholder="{{langMessage('cell number')}}" disabled>
    </div>
    @error('cell_number')
        <span class="text-danger" role="alert">
            <strong>{{langMessage(strtolower($message))}}</strong>
...
@section('pagejs')
<script>
$("#view_job_detail input").attr('disabled','disabled');
