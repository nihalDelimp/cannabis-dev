...
@section('content')
  ...
  <section class="content">
    ...
    @endif
    <form method="post" action="{{ route('template.store', app()->getLocale()) }}" enctype="multipart/form-data">
      @csrf
        <div class="form-group">
          <label for="petrol_saved">@lang(strtolower('Template Name'))<i class="fa fa-star text-red" aria-hidden="true"></i></label>
          <input type="text" name="name" value="{{ old('name') }}" class="form-control border-0 rounded-0 primary-text-color py-2 pl-3" placeholder="@lang(strtolower('Template Name'))" />
          @error('name')
        ...
        <div class="form-group">
          ...
          <input type="text" name="subject" value="{{ old('subject') }}" class="form-control border-0 rounded-0 primary-text-color py-2 pl-3" placeholder="@lang(strtolower('Subject'))" />
          @error('subject')
              <span class="text-danger" role="alert">
                  <strong>@lang(strtolower($message))</strong>
              </span>
        ...
        <div class="form-group">
          ...
          <input type="text" name="hint" value="{{ old('hint') }}" class="form-control border-0 rounded-0 primary-text-color py-2 pl-3" placeholder="@lang('Hint')" />
          @error('hint')
              <span class="text-danger" role="alert">
                  <strong>@lang(strtolower($message))</strong>
              </span>
        ...
        <div class="form-group">
          ...
          <textarea name="message_en" rows="8" cols="80" class="form-control border-0 rounded-0 primary-text-color py-2 pl-3" placeholder="@lang('English Message')">{{ old('message_en') }}</textarea>
          @error('message_en')
              <span class="text-danger" role="alert">
                  <strong>@lang(strtolower($message))</strong>
              </span>
        ...
        <!-- <div class="form-group">
          ...
          <textarea name="message_ar" rows="8" cols="80" class="form-control border-0 rounded-0 primary-text-color py-2 pl-3" placeholder="@lang('Arabic Message')">{{ old('message_ar') }}</textarea>
          @error('message_ar')
              <span class="text-danger" role="alert">
                  <strong>@lang(strtolower($message))</strong>
              </span>
