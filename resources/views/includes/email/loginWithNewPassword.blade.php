        ...
        <div class="puco-note__content">
            ...
            <div class="puco-text text_textBlock__WUY_8">
                <p class="puco-text">   <em>Hi {{$body['name']}},</em><br><br>
                    <em>
                        Hello and Thank you for signing up with Cannabis Capitol, we are excited for you to Join our VIP community experience and stay up to date on everything we do here. This email contains a link for you to create a new password and get started as an official member with Cannabis Capitol!
                        <br><br>
                        Please click the link below and follow the instructions on how to create your new password.
                    </em>
                        <br><br><br><br>
                    <em>
