    ...
    <div class="puco-note puco-note--blue">
        <div class="puco-note__content">
            ...
            <div class="puco-text text_textBlock__WUY_8">
                <p class="puco-text"><em>Hi {{$body['name']}},</em><br><br><em>Have you heard the news? Something big is coming from " {{$body['production_name']}} ".</em><br><br><em>On {{ $body['production_time']}}, we’ll be launching on this Time.</em><br><br><em>Be the first to learn everything about [Insert new product or service], as well as receive exclusive access to [Benefit of attending].</em><br><br><em>Get on the production link today! Please Click on </em>
                    <br><br><em>
